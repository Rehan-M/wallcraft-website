      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <button
     onClick={() => alert("Facebook link coming soon!")} className="bg-white/20 p-2 rounded-lg hover:bg-white/30 transition-colors">
                <Facebook className="w-5 h-5" />
              </button>
              <button
     onClick={() => alert("Instagram link coming soon!")} className="bg-white/20 p-2 rounded-lg hover:bg-white/30 transition-colors">
                <Instagram className="w-5 h-5" />
              </button>
              <button
     onClick={() => alert("Twitter link coming soon!")} className="bg-white/20 p-2 rounded-lg hover:bg-white/30 transition-colors">
                <Twitter className="w-5 h-5" />
              </button>
              <button
     onClick={() => alert("Linkedin link coming soon!")} className="bg-white/20 p-2 rounded-lg hover:bg-white/30 transition-colors">
